...
| Seven local user journeys | COMPLETE | [Checksummed journey artifact](benchmark-evidence/user-journeys-20260921-v3.json); unique repository-relative producer names; functional fixtures, not coding or capacity qualification |
