...
| Seven local user journeys | COMPLETE | [Checksummed journey artifact](benchmark-evidence/user-journeys-20260917-review-fix.json); functional fixtures, not coding or capacity qualification |
