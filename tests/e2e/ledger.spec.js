...
test('Ledger cache-busts a graph renderer that fetched but did not register', async ({ page }) => {
  ...
  expect(first.searchParams.get('v')).toBe('20260812-hierarchical-black-hole-orbits-6');
  ...
  expect(second.searchParams.get('v')).toBe('20260812-hierarchical-black-hole-orbits-6');
