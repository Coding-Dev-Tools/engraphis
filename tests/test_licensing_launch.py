...
# engraphis-cloud/engraphis_cloud/entitlements.py:20-28 and security.py:37-38.
...
def test_every_server_feature_key_advertises_the_plan_that_grants_it() -> None:
    ...
    for feature in sorted(SERVER_PLAN_FEATURES["team"]):
        granted_by_pro = feature in SERVER_PLAN_FEATURES["pro"]
