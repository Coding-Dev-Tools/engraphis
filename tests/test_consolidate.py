...
def test_archive_preserves_vector_for_historical_recall():
    ...
    # predicate would exclude the row. Nudge the archive stamp into the future so the
    # midpoint sits strictly inside [valid_from, valid_to).
    archived_at = time.time() + 0.5
