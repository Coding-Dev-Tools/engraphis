...
### Fixed
- Repaired documentation files affected by transient filesystem corruption and verified their contents before release.
...
## [Unreleased] — memory quality and product-surface pass
...
## [Unreleased] — memory lifecycle and code-graph pass

Adds deterministic memory lifecycle, bi-temporal history tools, and a code-aware symbol graph. All additions remain local-first.
...
- **Rebranded to a clean, independent Engraphis identity**: removed third-party SDK-compat
  framing, renamed the default database to `engraphis.db`, and updated public documentation.
