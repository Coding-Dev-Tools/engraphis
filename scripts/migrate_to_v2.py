"""Migrate a v1 (neocortex.db) database into the v2 Engraphis schema.
...
def main() -> None:
    ap = argparse.ArgumentParser(description="Migrate v1 neocortex.db → v2 Engraphis schema.")
    ap.add_argument("--old", default=str(_PROJECT_ROOT / "neocortex.db"))
