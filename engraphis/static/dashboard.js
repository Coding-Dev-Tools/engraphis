...
managedConsentHtml=function(feature){const privacyCopy=/cloud sync/i.test(feature)?CLOUD_SYNC_PRIVACY_COPY:MANAGED_COMPUTE_PRIVACY_COPY;return managedConsentHtmlBase(feature).replace('</div></section>',`<div class="hosted-opportunity-privacy"><strong>Privacy, by design.</strong> ${esc(privacyCopy)}</div></section>`)};
